...
namespace ZoneSearch
{
    ...
    {
        public static async Task<ZoneDictionary> DictionaryFromFiles(float[] zones, string path)
        {
            var files = Directory.GetFiles(path);
            var dict = new ZoneDictionary(zones, files.Select(s => new FileInfo(s).Name).ToArray());
